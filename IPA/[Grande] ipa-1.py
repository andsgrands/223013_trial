...
def savings(gross_pay, tax_rate, expenses):
    ...
    remaining_cents = after_tax - expenses
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    net_material = total_material - total_consumption
    
    final_material = str(net_material)+material_units
...
def body_mass_index(weight, height):
    ...
    height_m = ((12*height[0])+height[1])/39.37
